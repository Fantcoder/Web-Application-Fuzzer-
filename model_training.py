...
class Config:
    ...
    DATASET_PATH = os.path.normpath(r"C:\\Users\\Siddhant\\OneDrive\\Desktop\\ml code\\WebFuzzer-main\\fuzzer_dataset.csv")
    ...
    MIN_PAYLOADS = 3
    MAX_PAYLOADS = 7
    ML_PAYLOADS_FILE ="C:\\Users\\Siddhant\\OneDrive\\Desktop\\ml code\\WebFuzzer-main\\ml_payloads.txt"
    MODEL_DIR = "model_versions"
